...
**Key concepts:** function, algorithm, pseudo code
...
4.  Imagine you are writing a program to help you process data from a survey that you ran.
    ...
    -   Make a plan for how you would implement this program, listing out the steps in order as well as what output you would need to pass from one step to the next. You do not need to write any actual code for this problem - only the logical list of steps as a series of comments that you could use to structure your code.
