...
| 4 | Feb 6 | [Data Visualization](modules/04_data-visualization.html) | Exploratory data visualization with ggplot, customizing plots |
| 5 | Feb 13 | [Data Summaries & Data Relations](modules/05_data-summaries-relations.html) | Importing and summarizing data, tidyverse pipes; Combining datasets |
| 6 | Feb 20 | [Data Tidying & Data Wrangling](modules/06_data-tidying-wrangling.html) | What is “tidy data” and how do we get it; Selecting and filtering data, creating new variables |
| 7 | Feb 27 | [Intro to jsPsych](modules/07_intro-jspsych.html) | **Midterm projects due**; Implementing a simple experiment using jsPsych |
| 8 | Mar 13 | [Experiment Design and Data Collection](modules/08_experiment-design.html) | Designing more complex experiments with jsPsych, collecting data |
| 9 | Mar 20 | [Statistical Analysis in R](modules/09_statistical-analysis.html) | Basic statistical analysis in R, including t-tests, ANOVAs, and regression analyses on sample datasets |
| 10 | Mar 27 | [Intro to Machine Learning](modules/10_machine-learning.html) | Simple machine learning models for classifying or predicting psychological outcomes |
| 11 | Apr 3 | [Intro to Natural Language Processing](modules/11_nlp.html) | Text processing using NLP tools, sentiment analysis |
| 12 | Apr 10 | [Advanced Visualization Techniques](modules/12_advanced-visualization.html) | Interactive visualizations and web-based tools, visualization of complex data types |
...
Boston College defines credit hours in terms of how much in- and out-of-class time is spent on a course per week. You should expect to spend a minimum of 6 out-of-class hours per week on this 3-credit course.
...
Assignments are subject to a 5%-per-day penalty for each day that they are late. Every student will be allowed one "free" late turn-in that they can use for any of the weekly assignments. Assignments will generally be due by noon the day before class.
