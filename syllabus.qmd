...
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 4               | Feb 6           | [Programming Foundations Workshop](modules/03-1_programming-workshop.html)  | Review and practice                                                                                                   |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
...
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 6               | Feb 20          | [Data Summaries & Data Relations](modules/05_data-summaries-relations.html) | Importing and summarizing data, tidyverse pipes; Combining datasets                                                   |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 7               | Feb 27          | [Data Tidying & Data Wrangling](modules/06_data-tidying-wrangling.html)     | What is “tidy data” and how do we get it; Selecting and filtering data, creating new variables                        |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 8               | Mar 13          | [Intro to jsPsych](modules/07_intro-jspsych.html)                           | **Midterm projects due**; Implementing a simple experiment using jsPsych                                              |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 9               | Mar 20          | [Experiment Design and Data Collection](modules/08_experiment-design.html)  | Designing more complex experiments with jsPsych, collecting data                                                      |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 10              | Mar 27          | [Statistical Analysis in R](modules/09_statistical-analysis.html)           | Basic statistical analysis in R, including t-tests, ANOVAs, and regression analyses on sample datasets                |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 11              | Apr 3           | [Intro to Machine Learning](modules/10_machine-learning.html)               | Simple machine learning models for classifying or predicting psychological outcomes                                   |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 12              | Apr 10\         | [Intro to Natural Language Processing](modules/11_nlp.html)                 | Text processing using NLP tools, sentiment analysis                                                                   |
|                 | *Option 1*      |                                                                             |                                                                                                                       |
+-----------------+-----------------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
